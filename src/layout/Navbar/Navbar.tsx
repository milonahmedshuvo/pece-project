...
const Navbar = () => {
  ...
  return (
    <nav className=" shadow-md pr-7 flex items-center justify-between ">
  ...
  <div className="absolute top-0 right-0 w-1/2 h-full bg-[#134074] blur-2xl"></div>
        ...
        <input
          ...
          className="border border-gray-200 px-20 py-1 rounded-full w-64 md:w-[546px] ml-2 focus:outline-none focus:ring-2 focus:ring-blue-500 "
        />
      </div>

      {/* Right side: Profile */}
      <div className="flex items-center space-x-3">
        <span className="font-semibold text-[#163760]">Admin Name</span>
        <img
